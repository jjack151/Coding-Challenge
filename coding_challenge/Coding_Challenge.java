...
public class Coding_Challenge {
    ...
    public static void main(String[] args) throws FileNotFoundException{
        ...
        File DB_fileName = new File ("C:/sqlite/SQLite.db"); //File name for SQLite Database to be created
        String badCsv_Path = ("C:/sqlite/SQLite-bad.csv"); // File name for Bad CSV File to be created
        String CSV_Path = "C:/sqlite/Entry Level Coding Challenge Page 2.csv"; // File name for CSV File to be read from
        String log_Path = "C:/sqlite/Records.log";  // File name for Statistics log to be created
